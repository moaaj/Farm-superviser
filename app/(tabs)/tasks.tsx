      ...
      <Modal visible={showCreateModal} animationType="slide">
        <SafeAreaView style={styles.modalContainer}>
          <ScrollView contentContainerStyle={styles.modalContent} keyboardShouldPersistTaps="handled">
            ...
            <View style={styles.dateButtonsRow}>
              <TouchableOpacity 
                style={[styles.dateQuickButton, endDate && isSameDay(endDate, startDate) && styles.dateQuickButtonActive]}
                onPress={() => setEndDate(startDate || new Date())}
              >
                <Text style={[styles.dateQuickButtonText, endDate && isSameDay(endDate, startDate) && styles.dateQuickButtonTextActive]}>Same Day</Text>
              </TouchableOpacity>
              <TouchableOpacity 
              ...
              >
                <Text style={styles.dateQuickButtonText}>+3 Days</Text>
              </TouchableOpacity>
              <TouchableOpacity 
                style={[styles.dateQuickButton]}
                onPress={() => {
              ...
              >
                <Text style={styles.dateQuickButtonText}>+1 Week</Text>
              </TouchableOpacity>
            </View>
            {endDate && (
              <View style={styles.selectedDateDisplay}>
